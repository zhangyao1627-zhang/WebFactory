...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements IUserService {
    ...
    @Override
    @Transactional(rollbackFor = Exception.class)
    public void register(String username, String password,String phone,String roleid,String factoryname,String factorydetail) {
        System.out.println("At least get into the register page");
        System.out.println("在最终的这个表格里面");
        User user = new User();
        ...
        if(roleid.equals("81")){
            ...
            factory.setFactoryDetail(factorydetail);
